...
urlpatterns = [
        ...
        path('admin/file_view/<int:file_pk>',views.file_view, name='file_view'),
        path('admin/edit',views.file_edit, name='file_edit'),
        path('admin/word_add/<int:file_pk>',views.word_add, name='word_add'),
        path('admin/word_delete/<int:file_pk>',views.word_delete, name='word_delete'),
